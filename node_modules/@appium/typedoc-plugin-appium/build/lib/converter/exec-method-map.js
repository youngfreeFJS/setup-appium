 ...
 */
function convertExecuteMethodMap({ log, parentRefl, execMethodMapRefl, builtinMethods, strict = false, isPluginCommand = false, }) {
    ...
    for (const newMethodProp of newMethodProps) {
        ...
        const commentData = (0, comment_1.deriveComment)({ refl: methodRefl, comment, knownMethods: builtinMethods });
        commandRefs.add(new model_1.ExecMethodData(log, command, script, {
            requiredParams,
            optionalParams,
            refl: methodRefl,
