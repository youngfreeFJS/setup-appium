 ...
 */
export declare class ExtensionConverter extends BaseConverter<ProjectCommands> {
    #private;
     ...
     * @param log Logger
     */
    constructor(ctx: Context, log: AppiumPluginLogger, knownMethods: KnownMethods, builtinCommands?: ModuleCommands | undefined);
    /**
