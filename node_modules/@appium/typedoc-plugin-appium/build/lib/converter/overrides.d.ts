 ...
 */
export declare function convertOverrides({ log, parentRefl, classMethods, builtinMethods, newRouteMap, newExecMethodMap, builtinCommands, }: ConvertOverridesOpts): RouteMap;
/**
