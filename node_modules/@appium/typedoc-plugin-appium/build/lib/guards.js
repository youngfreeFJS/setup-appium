 ...
 * @param value
 */
function isAsyncMethodDeclarationReflection(value) {
    ...
    return Boolean(signatures?.find((sig) => isReferenceType(sig.type) && sig.type.name === 'Promise'));
}
exports.isAsyncMethodDeclarationReflection = isAsyncMethodDeclarationReflection;
/**
...
function isReferenceType(value) {
    return value instanceof typedoc_1.ReferenceType;
}
