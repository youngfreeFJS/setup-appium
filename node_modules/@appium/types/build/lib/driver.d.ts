 ...
 */
export declare type LogDefRecord<C extends Constraints> = Record<string, LogDef<C>>;
/**
 ...
 * This is likely unusable by external consumers, but YMMV!
 */
export declare type DriverClass<D extends Driver = ExternalDriver> = Class<D, DriverStatic<D>, [
 ...
 */
export declare type RouteMatcher = [HTTPMethod, RegExp];
