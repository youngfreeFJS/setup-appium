...
class AppiumDriver extends base_driver_1.DriverCore {
    ...
    async createSession(jsonwpCaps, reqCaps, w3cCapabilities, driverData) {
        ...
        try {
            ...
            const parsedCaps = (0, utils_1.parseCapsForInnerDriver)(jsonwpCaps, (0, base_driver_1.promoteAppiumOptions)(w3cCapabilities), this.desiredCapConstraints, defaultCapabilities);
