...
export declare type CliCommandServer = 'server';
export declare type CliCommandDriver = DriverType;
export declare type CliCommandPlugin = PluginType;
/**
 * Extension-specific commands
 */
export declare type CliExtensionCommand = CliCommandDriver | CliCommandPlugin;
/**
 * Possible commands for the `appium` CLI.
 */
export declare type CliCommand = CliCommandServer | CliExtensionCommand;
/**
 ...
 */
export declare type CommonArgs<Cmd extends CliCommand = CliCommandServer, SubCmd extends CliExtensionSubcommand | void = void> = MoreArgs & ProgrammaticArgs & (Cmd extends CliCommandServer ? ServerArgs : Cmd extends CliExtensionCommand ? SubCmd extends CliExtensionSubcommand ? ExtArgs<Cmd, SubCmd> : never : never);
/**
 * Fully-parsed arguments, containing defaults, computed args, and config file values.
 */
export declare type ParsedArgs<Cmd extends CliCommand = CliCommandServer, SubCmd extends CliExtensionSubcommand | void = void> = CommonArgs<Cmd, SubCmd>;
/**
 ...
 */
export declare type Args<Cmd extends CliCommand = CliCommandServer, SubCmd extends CliExtensionSubcommand | void = void> = Cmd extends CliCommandServer ? SetOptional<CommonArgs<Cmd>, keyof ServerArgs> : ParsedArgs<Cmd, SubCmd>;
/**
